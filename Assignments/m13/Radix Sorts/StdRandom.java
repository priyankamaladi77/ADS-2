...
public final class StdRandom {
     ...
     * @return a random integer uniformly between
     * 0 (inclusive) and {@code n} (exclusive)
    ...
    public static long uniform(final long n) {
        ...
        //java/util/Random.html#longs-long-long-long-
     ...
     */
    public static double gaussian(final double mu,
        final double sigma) {
    ...
    /**
     * Returns a random integer from a Poisson
     * distribution with mean &lambda;.
     *
     * @param  lambda the mean of the Poisson distribution
     * @return a random integer from a Poisson
     * distribution with mean {@code lambda}
     * @throws IllegalArgumentException
     ...
     * {@code probabilities} is {@code null}
     * @throws IllegalArgumentException if sum of array
     * entries is not (very nearly) equal to {@code 1.0}
     * @throws IllegalArgumentException unless
    ...
    public static int discrete(final double[] probabilities) {
        ...
        // the for loop may not return a value
        // when both r is (nearly) 1.0 and when the
        // cumulative sum is less than 1.0
     ...
     * specified subarray in uniformly random order.
     *
     * @param  a the array to shuffle
    ...
    /**
     * Rearranges the elements of the
     * specified subarray in uniformly random
     * order.
     *
     * @param      a     the array to shuffle
     * @param      lo    the left endpoint (inclusive)
     ...
     */
    private static void validateSubarrayIndices(final int lo,
        final int hi, final int length) {
